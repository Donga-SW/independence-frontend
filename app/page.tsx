...
export default function HomePage() {
  ...
  return (
    <div className="relative">
      ...
      {/* About Section */}
      <section className="bg-[#e9e4da] w-full py-12 md:py-24 lg:py-32">
      ...
      {/* 인물 Section */}
      <section className="relative bg-cover bg-center bg-no-repeat py-12 md:py-24 lg:py-32" style={{ backgroundImage: "url('/images/태극기2.png')" }}>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-white md:text-xl/relaxed">
                독립운동을 이끈 주요 인물들의 삶과 업적 및 판결문을 소개합니다.
              </p>
            </div>
          </div>
